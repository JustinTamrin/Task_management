...
class TotalTask extends StatefulWidget {
  ...
  const TotalTask({super.key, required this.onSaveCallback});
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream: _firestore.collection('tasks').where('status',
              whereIn: ['Completed', 'Uncompleted', 'In progress']).snapshots(),
