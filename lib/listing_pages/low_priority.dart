...
class LowPriority extends StatefulWidget {
  ...
  const LowPriority({super.key, required this.onSaveCallback});

  @override
  State<LowPriority> createState() => _LowPriorityState();
}
        ...
        child: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return const Center(child: Text('No low priority tasks found.'));
            } else {
              return ListView(
